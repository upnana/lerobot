...
from transformers.utils import TensorType, add_start_docstrings, auto_docstring, is_torch_available, is_torchvision_v2_available
...
class Eagle2_5_VLImageProcessorFast(BaseImageProcessorFast):
    ...
    def _preprocess(
        ...
        **kwargs,
        ...
        for image in images:
            ...
            grouped_image_patches, grouped_image_patches_index = group_images_by_shape(image_patches,disable_grouping=disable_grouping)
    ...
    def preprocess(self, images: ImageInput, videos: VideoInput=None, **kwargs: Unpack[Eagle2_5_VLFastImageProcessorKwargs]) -> BatchFeature:
        ...
        # Update kwargs that need further processing before being validated (includes torch resize uses interpolation instead of resample)
        kwargs = self._further_process_kwargs(**kwargs)

        # Validate kwargs
        self._validate_preprocess_kwargs(**kwargs)

        # torch resize uses interpolation instead of resample (hack to keep compatible between transformers>= 4.56.0 and < 4.56.0)
...
Eagle25VLImageProcessorFast = Eagle2_5_VLImageProcessorFast

# Compatibility patch for transformers API
if not hasattr(Eagle2_5_VLImageProcessorFast, "_prepare_image_like_inputs"):
    Eagle2_5_VLImageProcessorFast._prepare_image_like_inputs = Eagle2_5_VLImageProcessorFast._prepare_video_like_inputs

# Compatibility patch for transformers API
def _groot_prepare_image_like_inputs(self, images=None, **kwargs):
    return self._prepare_video_like_inputs(videos=images, **kwargs)

Eagle2_5_VLImageProcessorFast._prepare_image_like_inputs = _groot_prepare_image_like_inputs
Eagle25VLImageProcessorFast._prepare_image_like_inputs = _groot_prepare_image_like_inputs
