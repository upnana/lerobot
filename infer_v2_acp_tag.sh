#!/bin/bash
# =============================================================================
# 真机评测：bowls_tray_3cam_v2 + Advantage: positive（带 ACP tag）
#
# Usage:
#   bash /home/rxn/lerobot/infer_v2_acp_tag.sh              # 默认 120000
#   bash /home/rxn/lerobot/infer_v2_acp_tag.sh 100000
#   NUM_EPISODES=2 EPISODE_TIME_S=300 bash /home/rxn/lerobot/infer_v2_acp_tag.sh
#   OVERLAY_VALUE=0 bash /home/rxn/lerobot/infer_v2_acp_tag.sh
# =============================================================================
set -euo pipefail
...
echo "=============================="
echo "infer v2 + ACP tag  ckpt ${STEP}"
